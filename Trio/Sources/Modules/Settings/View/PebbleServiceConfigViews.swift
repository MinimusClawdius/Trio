...
struct PebbleSetupView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context _: UIViewControllerRepresentableContext<PebbleSetupView>) -> UIViewController {
    ...
    func updateUIViewController(_: UIViewController, context _: UIViewControllerRepresentableContext<PebbleSetupView>) {}
}

struct PebbleSettingsView: UIViewControllerRepresentable {
    let serviceUI: ServiceUI
    let serviceOnBoardDelegate: ServiceOnboardingDelegate
    let serviceDelegate: CompletionDelegate?

    func makeUIViewController(context _: UIViewControllerRepresentableContext<PebbleSettingsView>) -> UIViewController {
    ...
    func updateUIViewController(_: UIViewController, context _: UIViewControllerRepresentableContext<PebbleSettingsView>) {}
}
